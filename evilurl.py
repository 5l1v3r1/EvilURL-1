...
#------------------------------------------------------
#
#      BY:    WaSim Akram from Pakistan :)
#      Visit: https://www.youtube.com/c/thelinuxchoice
#      Github: https://github.com/evildevill/EvilURL
#------------------------------------------------------
...
{0}88888888888  "8"      88  88{1}   `"Y8888Y"'   88      `8b  88888888  {1}
			 ...
			 [ WaSim{0}Akram{1} from Pa{1}kiStaN ]
-> github.com/evildevill
-> youtube.com/c/thelinuxchoice       
